...
module.exports.render = function (context, modelIn) {
	...
	model.image = content.image ? content.image.file.url : null;
	// model.imageMob = content.imageMob ? content.imageMob.file.url : null;
	...
	return new Template(
		"experience/components/commerce_assets/promotionalBanner"
	).render(model).text;
};
