...
module.exports.render = function (context, modelIn) {
    ...
    model.imgFile = content.imgFile ? ImageTransformation.getScaledImage(content.imgFile) : '';
    ...
    model.tileLink = content.tileLink ? content.tileLink : "";
    ...
    return new Template('experience/components/commerce_assets/verticalContentTile').render(model).text;
};
