...
/**
 * Render logic for the pd_layouts.PD Plus 3 Row x 1 Col (Mobile), PD Plus 1 Row x 3 Col (Desktop) layout
...
module.exports.render = function (context, modelIn) {
    ...
    return new Template('experience/components/pd_layouts/pdPlusGrid3r1c').render(model).text;
};
