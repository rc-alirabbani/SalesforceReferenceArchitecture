...
/**
 * Render logic for the pd_layouts.PD Plus 2 Row x 2 Col (Mobile), PD Plus 1 Row x 4 Col (Desktop) layout
...
module.exports.render = function (context, modelIn) {
    ...
    return new Template('experience/components/pd_layouts/pdPlusGrid2r2c').render(model).text;
};
