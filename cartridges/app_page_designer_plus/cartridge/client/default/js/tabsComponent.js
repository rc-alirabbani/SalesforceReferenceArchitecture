...
$(document).ready(function () {
    var firstTabDescription = $('.tab-container .experience-pd_assets-pdPlusTabs:first-child').find('.tab-description').html();
    ...
    $('.experience-pd_assets-pdPlusTabs').find('[data-bs-toggle="tab"]').click(function(){
        ...
        var tabDescription = $(this).parents('.tabItem').find('.tab-description').html();
